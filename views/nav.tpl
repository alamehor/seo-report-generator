  ...
  <aside class="">
    <nav>
      ...
      <ul class="nav flex-column mt-3">
        <li class="nav-item"><a href="" class="nav-link">{$nav.home}</a></li>
        <li class="nav-item"><a href="" class="nav-link">{$nav.new}</a></li>
        <li class="nav-item"><a href="" class="nav-link">{$nav.all}</a></li>
        <li class="nav-item"><a href="" class="nav-link">{$nav.my}</a></li>
      {* Navigation for admin only *}
      <span class="h4 mt-5">Admin panel</span>
      <ul class="nav flex-column mt-2">
        <li class="nav-item"><a href="" class="nav-link">{$nav.users}</a></li>
        <li class="nav-item"><a href="" class="nav-link">{$nav.categories}</a></li>
        <li class="nav-item"><a href="" class="nav-link">{$nav.company}</a></li>
    </nav>
  </aside>
